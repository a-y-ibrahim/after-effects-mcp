...
**57 tools total.** Full details in [ENHANCEMENTS.md](ENHANCEMENTS.md).
...
📖 Full reference: [docs/TOOLS.md](docs/TOOLS.md) (all 57 tools) · [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) (how the bridge works).
